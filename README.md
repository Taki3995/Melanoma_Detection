# Instrucciones
Este trabajo se puede revisar / ejecutar tanto desde el archivo "melanoma_detection.ipynb" como corriendo el archivo "main.py" de la carpeta "Python Code". Ambos tienen lo mismo, pero desde el Jupyter Notebook se puede visualizar las celdas ya ejecutadas. 
